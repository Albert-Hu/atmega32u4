...
static void command_help(void *user_data, int argc, char *argv[]);
static void command_version(void *user_data, int argc, char *argv[]);
static void command_reboot(void *user_data, int argc, char *argv[]);
